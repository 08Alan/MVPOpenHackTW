...
var Badge = function (_React$Component) {
    ...
    _createClass(Badge, [{
        ...
        value: function render() {
            ...
            var scrollNumberCls = classNames((_classNames = {}, _defineProperty(_classNames, prefixCls + '-dot', isDot), _defineProperty(_classNames, prefixCls + '-count', !isDot), _defineProperty(_classNames, prefixCls + '-multiple-words', count && count.toString && count.toString().length > 1), _classNames));
