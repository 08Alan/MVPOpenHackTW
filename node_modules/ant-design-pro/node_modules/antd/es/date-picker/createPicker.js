    ...
    return _a = function (_React$Component) {
        ...
        _createClass(CalenderWrapper, [{
            ...
            value: function render() {
                ...
                var calendar = React.createElement(TheCalendar, _extends({}, calendarProps, { disabledDate: props.disabledDate, disabledTime: disabledTime, locale: locale.lang, timePicker: props.timePicker, defaultValue: props.defaultPickerValue || moment(), dateInputPlaceholder: placeholder, prefixCls: prefixCls, className: calendarClassName, onOk: props.onOk, dateRender: props.dateRender, format: props.format, showToday: props.showToday, monthCellContentRender: props.monthCellContentRender, renderFooter: this.renderFooter, onPanelChange: props.onPanelChange }));
                ...
                return React.createElement(
                    'span',
                    { className: classNames(props.className, props.pickerClass), style: props.style },
                    React.createElement(
                        RcDatePicker,
