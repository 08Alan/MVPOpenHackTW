...
var TreeSelect = function (_React$Component) {
    ...
    function TreeSelect(props) {
        ...
        _this.renderTreeSelect = function (locale) {
            ...
            return React.createElement(RcTreeSelect, _extends({}, restProps, { prefixCls: prefixCls, className: cls, dropdownStyle: _extends({ maxHeight: '100vh', overflow: 'auto' }, dropdownStyle), treeCheckable: checkable, notFoundContent: notFoundContent || locale.notFoundContent }));
        };
