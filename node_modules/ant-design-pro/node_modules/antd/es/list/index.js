    ...
    _createClass(List, [{
        ...
        value: function render() {
            ...
            var _a = this.props,
                ...
                bordered = _a$bordered === undefined ? false : _a$bordered,
                _a$split = _a.split,
                split = _a$split === undefined ? true : _a$split,
                ...
                dataSource = _a$dataSource === undefined ? [] : _a$dataSource,
                size = _a.size,
                rowKey = _a.rowKey,
            ...
            var childrenList = React.Children.map(dataSource.map(function (item, index) {
            ...
            var childrenContent = grid ? React.createElement(
                Row,
                { gutter: grid.gutter },
                childrenList
            ) : childrenList;
